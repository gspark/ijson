...
void WxBarPrivate::setIconDark(bool dark)
{
    ...
    //m_closeIcon = QApplication::style()->standardIcon(QStyle::SP_TitleBarCloseButton);
    m_closeIcon = QIcon(QString(":/qss_icons/%1/rc/close.svg").arg(suffix));
    ...
    //m_minimizeIcon = QApplication::style()->standardIcon(QStyle::SP_TitleBarMinButton);
    m_minimizeIcon = QIcon(QString(":/qss_icons/%1/rc/min.svg").arg(suffix));
    ...
    //m_maximizeIcon = QApplication::style()->standardIcon(QStyle::SP_TitleBarMaxButton);
    m_maximizeIcon = QIcon(QString(":/qss_icons/%1/rc/max.svg").arg(suffix));
    ...
    //m_normalIcon = QApplication::style()->standardIcon(QStyle::SP_TitleBarNormalButton);
    m_normalIcon = QIcon(QString(":/qss_icons/%1/rc/restore.svg").arg(suffix));
